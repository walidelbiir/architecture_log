...
public class EncodingModule implements IEncoding
{
    private IdataStorage database;

    public EncodingModule(IdataStorage database) {
    ...
    public void encodeWithFiles() throws IOException
    {
        ...
        try {
            reader = new BufferedReader(
                new FileReader("DIP/src/com/directi/training/dip/solution/beforeEncryption.txt"));
            writer = new BufferedWriter(
                new FileWriter("DIP/src/com/directi/training/dip/solution/afterEncryption.txt"));
            String aLine;
